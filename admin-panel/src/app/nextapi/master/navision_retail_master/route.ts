  ...
  try {
    ...
    const rows = await db
      .select({
        ...
        agentName: navisionRetailMaster.agentName,
        agentCode: navisionRetailMaster.agentCode,
        salesPersonCode: navisionRetailMaster.salesPersonCode,
        salesPersonName: navisionRetailMaster.salesPersonName,
