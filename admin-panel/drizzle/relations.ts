...
import { userMaster, distributor, redemptionRequest, pointAllocationLog, transaction, notificationLog, retailer, salesperson, userRoles, permissions, rolePermissions } from "../src/db/schema";
