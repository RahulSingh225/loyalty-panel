...
import { userMaster, pointAllocationLog, transaction, redemptionRequest, distributor, notificationLog, redemptionRewardLines, retailer, userRoles, salesperson, permissions, rolePermissions } from "./schema";
